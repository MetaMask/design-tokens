...
export const colors: ThemeColors = {
  ...
  icon: {
    default: brandColor.textdefault,  // For default neutral icons
    alternative: brandColor.textalternative,  // For softer neutral icons
    muted: brandColor.textmuted,  // For the weakest contrast neutral icons (not accessible)
  },
  border: {
  ...
  primary: {
    ...
    muted: brandColor.blue400_15,  // For the weakest contrast primary semantic backgrounds.
  ...
  error: {
    ...
    muted: brandColor.red400_15,  // For the weakest contrast critical alert semantic backgrounds.
  ...
  warning: {
    ...
    muted: brandColor.yellow100_15,  // For the weakest contrast caution alert semantic backgrounds.
  ...
  success: {
    ...
    muted: brandColor.green400_15,  // For the weakest contrast positive semantic backgrounds.
  ...
  info: {
    ...
    muted: brandColor.blue400_15,  // For the weakest contrast informational semantic backgrounds.
